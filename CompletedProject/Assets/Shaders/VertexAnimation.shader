Shader "Custom/WavyVertexShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
                v.pos.xyz += CalculateWindVertexDispLocalXZY(v.pos, _Amplitude, _Frequency, _Time, _Speed);
        ...
        Pass
        {
            ...
            {
                v2f o;
                v.vertex.xyz += CalculateWindVertexDispLocalXZY(v.vertex, _Amplitude, _Frequency, _Time, _Speed);
